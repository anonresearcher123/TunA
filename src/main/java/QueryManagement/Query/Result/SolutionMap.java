...
public class SolutionMap {
    private final Map<Pair<Integer,String>, List<String>> solutionsMap;
        ...
        for(Map.Entry<Pair<Integer,String>,List<FuncInstance>> gapEntry : gapMap.entrySet()){
            ...
            for(FuncInstance instance : gapInstances){
                ...
                if(response != null){
                    ...
                    else solutions = new LinkedList<>();

                    if(extrData != null && extrData.size() == 1){
                        solutions.add(extrData.get(0));
    ...
    public List<String> get(int row, String relation){
        for(Map.Entry<Pair<Integer,String>,List<String>> entry : this.solutionsMap.entrySet()){
